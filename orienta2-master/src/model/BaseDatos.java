...
public class BaseDatos {
  ...
  //Agregar articulos
    ...
    public static void cargarDatos(){
        ...
        clienteP = new ClientePremium("Veronica", "Cadiz", "66666", "veronica@veronica.veronica");
        ...
        clienteP = new ClientePremium("Paco", "Murcia", "77777", "paco@paco.paco");
        ...
        clienteP = new ClientePremium("Patri", "Granada", "888888", "patri@patri.patri");
        ...
        clienteP = new ClientePremium("Irene", "Barcelona", "99999", "irene@irene.irene");
        ...
        clienteP = new ClientePremium("Izan", "Mallorca", "11112", "izan@izan.izan");
